...
# elements (if they exist). Your task is to find the index of any peak element in the 
# given array
...
# 1 3 20 4 1
# Sample Output:
# 2 #To return an index value we have to use range in for loop else use (arr)
inp1=input()
for i in range
