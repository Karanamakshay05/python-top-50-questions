...
# denoting the sequence results you get on the tass of coin N times. Your task is to
#  find and return an integer value representing the final score you get once the game
#  ends.
# Note: The final score can be negative too.
# Input Specification:
# Input1: A string s. representing the sequence of results you get on the 
# toss of coin N times
# Sample Input:
# HHHTT
# Output:
# 6
...
for i in toss:
    if(i=="H"):
        ...
        if(head==3):
            ...
            score-=1
            head=0 #not mandatory but may be in worst case it may be useful
print(score)
